            ...
            <table class="table is-fullwidth" id="myTable">
                ...
                <c:forEach var="rv" items="${rvList }" varStatus="status">
                    <tr>
                        ...
                        <td class="item3">
                            <a href="${path}/lecture/getLecture?no=${rv.par}" class="btn1">상세</a>
                            <a href="${path}/admin/adminDeleteReview.do?id=${rv.id}&par=${rv.par}" class="btn1">제거</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
