...
<head>
    ...
    <style>
        /* 본문 영역 스타일 */
        .contents { clear:both; min-height: 60vh; background-image: url("../img/login.jpg");
            background-repeat: no-repeat; background-position: center -250px; }
        .contents::after { content:""; clear:both; display:block; width:100%; }

        .page { clear:both; width: 100vw; min-height: 60vh; position:relative; }
            ...
            <div class="page_wrap">
                <table class="tb1">
                    <thead>
                        ...
                        <tr>
                            <td style="width: 5%; float: left; text-align: left">
                            ...
                            <td style="width: 55%">
                                ...
                                <a href="${path}/infoUni/delete.do?bno=${dto.bno}" class="button is-danger is-outlined" >삭제</a>
                               </c:if>
                            </td>
